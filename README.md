...
Adds Memgraph connectivity as an installable connector extension.
...
The Rust code keeps native ABI exports in `src/lib.rs`, shared buffer/JSON helpers in `src/abi.rs`, and Memgraph behavior in `src/driver.rs`.
